...
public class MemberService {
	...
	/*
	 * public List<MemberDto> viewMember() { List<MemberDto> memberList =
	 * memberMapper.viewMember();
	 * 
	 ...
	 * memberList.get(i).setUserLevel("관리자"); }else
	 * if("2".equals(memberList.get(i).getUserLevel())) {
	 * memberList.get(i).setUserLevel("트레이너"); }else
	 * if("3".equals(memberList.get(i).getUserLevel())) {
	 * memberList.get(i).setUserLevel("사용자"); } }
	 * 
	 * System.out.println("전체회원 조회" + memberList); System.out.println("test");
	 * 
	 * return memberList;
	 * 
	 * }
