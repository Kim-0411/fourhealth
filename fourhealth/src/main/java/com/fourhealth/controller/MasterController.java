...
//		
//		//관리자 단에서 전체 회원 리스트 검색 처리
//		@PostMapping("/searchMemberAllList")
//		public String member_all_list(@RequestParam(name = "m_search_1", required = false) String searchKey
//										,@RequestParam(name = "m_search_2", required = false) String searchValue
//										,Model model) {
//			log.info("화면에서 전달받은 파라미터 값 m_search_1 ::: {}", searchKey);
//			log.info("화면에서 전달받은 파라미터 값 m_search_2 ::: {}", searchValue);
//			
//			System.out.println(searchKey + searchValue + "되나");
//			
//			if(searchKey != null && "아이디".equals(searchKey)) {
//				searchKey = "memberId";
//			}else if(searchKey != null && "이름".equals(searchKey)) {
...
//				searchValue = "1";
//			}else if(searchValue != null && "트레이너".equals(searchValue)) {
//				searchValue = "2";				
//			}else if(searchValue != null &&	"사용자".equals(searchValue)) {
//				searchValue = "3";
//			}else {
//				searchValue = "";
//			}
...
//			model.addAttribute("member_all_list", memberService.getSearchMemberList(searchKey, searchValue));
//			System.out.println("어디까지" + searchKey);
//			//return "redirect:/";
