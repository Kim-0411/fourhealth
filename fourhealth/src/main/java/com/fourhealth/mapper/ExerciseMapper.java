...
public interface ExerciseMapper {
	...
	// 전체 운동조회2
	public List<MetExerciseDto> getAllExerciseList2();

	// 전체 운동조회1(기존)
	public List<MetExerciseDto> getAllExerciseList();

	// 운동 검색 결과
	public List<Map<String, Object>> getAllSearchExerciseList(String exercise_name, String met_coefficient,
			String startRow, String rowPerPage);
